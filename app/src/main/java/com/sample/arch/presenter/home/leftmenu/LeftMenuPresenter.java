...
public class LeftMenuPresenter implements LeftMenuContract.Presenter {
    ...
    @Inject
    public LeftMenuPresenter(LeftMenuContract.View view, RxBinder<ActivityEvent> rxBinder, SetGetUserInteractor setGetUserInteractor, UserDataAdapter userDataAdapter, UserInteractor userInteractor) {
        mView = view;
        mRxBinder = rxBinder;
